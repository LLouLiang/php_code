      ...
      <div class="row">
        ...
        <div clas="col-md-12">
          <h1 id="header" class="text-center">Vetworking System</h1>
				...
				<!-- including the job fair recruiter's header -->
					...
					<?php
						...
						if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['offer'])) {
							...
							echo "<div class='alert alert-success alert-dismissible' role='alert'>
								...
								$to = $email;
								$subject = 'You have got an offer from a Job Fair Recruiter';
								$message = "Hi ". $fname .", \n\nYou have an offer from a Job Fair Recruiter from Vetworking Sysyem .\nClick here to login.\nhttp://vetworking.x10host.com/bootstrap-3.3.6-dist/index.php\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<?php
								...
								while ($row = mysqli_fetch_array($rr)){
									echo "<form action='job_fair_recruiter_offer_recruitment.php' method='POST'>";
										echo "<tr>";
