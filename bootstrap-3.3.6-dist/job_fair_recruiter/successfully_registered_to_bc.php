...
<html lang="en">
  <head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
		...
		<meta http-equiv="refresh" content="6; url=job_fair_recruiter_offer_recruitment.php">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
					...
					<a href = "job_fair_recruiter_offer_recruitment.php">Or click here to go to the same page directly.</a>
        </div> <!-- /.jumbotron -->
