    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
					...
					<?php
						...
						if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['offer'])) {
							...
							echo "<div class='alert alert-success alert-dismissible' role='alert'>
								...
								$to = $email;
								$subject = 'You have got an offer from a Career Coach';
								$message = "Hi ". $fname .", \n\nYou have an offer from a Career Coach from Vetworking Sysyem .\nClick here to login.\nhttp://vetworking.x10host.com/bootstrap-3.3.6-dist/index.php\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
					...
					<p>Here is a list of the boot camps that you can offer coaching to:</p>
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<?php
								...
								while ($row = mysqli_fetch_array($rr)){
									echo "<form action='career_coach_offer_coaching.php' method='POST'>";
										echo "<tr>";
