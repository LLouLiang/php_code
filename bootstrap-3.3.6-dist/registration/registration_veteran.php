    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
					...
					<?php
						...
						if ($_SERVER['REQUEST_METHOD'] == 'POST'){
							...
							if(empty($veteran_date_became)) $error[]= "<div class='alert alert-danger alert-dismissible' role='alert'>
																												...
																												<strong>Warning!</strong> You forgot to select the Date you become a Veteran!
																												</div>";
							...
							$reg_date = date("y-m-d h:i:s");
								...
								if ($r && $emp_status == 'Employee' && $role == 'veteran'){
									//send confirmation to users email
									echo "<center>you have registered succesfuly, please check your email</center>";
									$to = $email;
									$subject = 'Confirmation to register for Vetworking system';
								...
								if ($r && $emp_status == 'Non Employee' && $role == 'veteran'){
									//send confirmation to users email
									echo "<center>you have registered succesfuly, please check your email</center>";
									$to = $email;
									$subject = 'Confirmation to register for Vetworking system';
									$message = "Hi ". $fname .", \n\nregister for Vetworking system .\nClick here to login.\nhttp://vetworking.x10host.com/Vetworking%20System/index.php\n\nYou can Start to request mentors\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
									$headers = 'From: Vetworking System' . "\r\n" .
												'Reply-To: ' . "\r\n" .
												'X-Mailer: PHP/' . phpversion();
									mail($to, $subject, $message, $headers);
          ...
          <form action="registration_veteran.php" method="POST" class="form-horizontal" enctype="multipart/form-data">

						<div class='alert alert-info alert-dismissible' role='alert'>
							<button type='button' class='close' data-dismiss='alert' aria-label='Close'>
								<span aria-hidden='true'>&times;</span>
							</button>
							You are registering as a <strong>Veteran</strong>
						</div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="startPicker" placeholder="Approximate Date" name="veteran_date_became" value =
								<?php if(isset($_POST['veteran_date_became'])) echo $_POST['veteran_date_became'] ?>>
              </div>
            </div>
            <!-- /date became a Veteran -->
            ...
            <!-- industry_work -->
            <div class="form-group">
              <label for="industry_work" class="col-sm-2 control-label">Industry in which you work / have worked:</label>
              <div class="col-sm-10">
                <?php
            ...
            <!-- /industry_work -->
						...
						<!-- industry_interested -->
						<div class="form-group">
							<label for="industry_interested" class="col-sm-2 control-label">Industry you’re interested in:</label>
							<div class="col-sm-10">
								<?php
									$industry_interested=array("IT", "Business", "Health Care");
