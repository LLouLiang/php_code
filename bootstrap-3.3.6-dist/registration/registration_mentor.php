    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
						...
						if ($_SERVER['REQUEST_METHOD'] == 'POST'){
							...
							$reg_date = date("y-m-d h:i:s");
								...
								if ($r && $role == 'mentor'){
									...
									$to = $email;
									$subject = 'Confirmation to register for Vetworking system';
									$message = "Hi ". $fname .", \n\nregister for Vetworking system .\nClick here to login.\nhttp://vetworking.x10host.com/Vetworking%20System/index.php\n\nYou can start to offer mentorships\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
									$headers = 'From: Vetworking System' . "\r\n" .
												'Reply-To: ' . "\r\n" .
												'X-Mailer: PHP/' . phpversion();
									mail($to, $subject, $message, $headers);
					...
					<form action="registration_mentor.php" method="POST" class="form-horizontal" enctype="multipart/form-data">

						<div class='alert alert-info alert-dismissible' role='alert'>
							<button type='button' class='close' data-dismiss='alert' aria-label='Close'>
								<span aria-hidden='true'>&times;</span>
							</button>
							You are registering as a <strong>Mentor</strong>
						</div>
