...
<html lang="en">
  <head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
		...
		<meta http-equiv="refresh" content="5; url=panelist_recruiter_edit_profile.php">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
					<div class="alert alert-success" role="alert"><strong>Well done! </strong>Your profile has been updated successfully :)</div>
					<h4>You'll be redirected to the same page .. Please wait</h4>
					<a href = "panelist_recruiter_edit_profile.php">Or click here to go to the same page directly.</a>
        </div> <!-- /.jumbotron -->
