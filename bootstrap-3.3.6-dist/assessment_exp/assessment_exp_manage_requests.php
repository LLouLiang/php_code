					...
					<div class="table-responsive">
						...
						<?php
							...
							while ($row = mysqli_fetch_array($r)){
								echo "<form action='assessment_expert_manage_requests.php' method='POST'>";
								echo "<tr>";
								...
								echo "<td>".$row['bc_location']."</td>";
									...
									//<a onClick=\"javascript: return confirm('Do you really want to approve this request?');\">'
									echo '</td>';
									echo '<td id="center-th"><input type = "submit" class="btn btn-warning" name = "decline" value = "Decline" />';
									//<a onClick=\"javascript: return confirm('Do you really want to decline this request?');\">'
									echo '</td>';
