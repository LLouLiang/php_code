      ...
      <div class="row">
        ...
        <div clas="col-md-12">
          <h1 id="header" class="text-center">Vetworking System</h1>
				...
				<!-- including the assessment exp's header -->
        ...
        <div class="jumbotron">
	          ...
	          <form action="assessment_exp_edit_profile.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
