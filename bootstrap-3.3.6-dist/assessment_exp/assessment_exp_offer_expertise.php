      ...
      <div class="row">
        ...
        <div clas="col-md-12">
          <h1 id="header" class="text-center">Vetworking System</h1>
				...
				<!-- including the assessment expert's header -->
				<?php include("../includes/assessment_expert_header.html"); ?>

				<?php
					if( (empty($_SESSION['uname'])) || ($_SESSION['role'] != 'assessment_expert') )
					{
        ...
        <div class="jumbotron">
					...
					<?php
						...
						if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['offer'])) {
							...
							echo "<div class='alert alert-success alert-dismissible' role='alert'>
										...
										<strong>Warning!</strong> You have sent your offer to the boot camp!
										</div>";

								$to = $email;
								$subject = 'You have got an offer from an Assessment Expert';
								$message = "Hi ". $fname .", \n\nYou have an offer from an Assessment Expert from Vetworking Sysyem .\nClick here to login.\nhttp://vetworking.x10host.com/bootstrap-3.3.6-dist/index.php\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
					...
					<p>Here is a list of the boot camps that you can offer expertise to:</p>

					<!-- Open this div  if you want to to make them scroll horizontally on small devices -->
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<?php
								...
								while ($row = mysqli_fetch_array($rr)){
									echo "<form action='assessment_exp_offer_expertise.php' method='POST'>";
										echo "<tr>";
											...
											echo '<td id="center-th"><input type = "submit" class="btn btn-success" name = "offer" value = "Offer" />';
											echo '</td>';
