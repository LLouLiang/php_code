      ...
      <div class="row">
        <div clas="col-md-12">
          <h1 id="header" class="text-center">Vetworking System</h1>
				...
				<!-- including the assessment_exp's header -->
        ...
        <div class="jumbotron">
					...
					<?php
						...
						echo "<div class='alert alert-warning alert-dismissible' role='alert'>
							...
							$to = $email;
							$subject = 'An Assessment Expert has canceled attending to boot camp';
							$message = "Hi ". $fname .", \n\nThe Assessment Expert $_SESSION[uname] has canceled his/her attending to the boot camp! .\nClick here to login.\nhttp://vetworking.x10host.com/bootstrap-3.3.6-dist/index.php\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
					...
					<div class="table-responsive">
						...
						<?php
							...
							while ($row = mysqli_fetch_array($r)){
								echo "<form action='assessment_exp_cancel_expertise.php' method='POST'>";
								echo "<tr>";
