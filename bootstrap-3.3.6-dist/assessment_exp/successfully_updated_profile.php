...
<html lang="en">
  <head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
		...
		<meta http-equiv="refresh" content="5; url=assessment_exp_edit_profile.php">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
					...
					<a href = "assessment_exp_edit_profile.php">Or click here to go to the same page directly.</a>
        </div> <!-- /.jumbotron -->
