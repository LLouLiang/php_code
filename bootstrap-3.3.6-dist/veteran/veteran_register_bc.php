					...
					<?php
						...
						if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
							...
							echo "<div class='alert alert-success alert-dismissible' role='alert'>
								...
								$to = $email;
								$subject = 'You have got a registration request from a Veteran';
								$message = "Hi ". $fname .", \n\nYou have a registration request from a Veteran from Vetworking Sysyem .\nClick here to login.\nhttp://vetworking.x10host.com/bootstrap-3.3.6-dist/index.php\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
						...
						<tbody id = "myTable">
							<?php
								...
								while ($row = mysqli_fetch_array($rr)){
									echo "<form action='veteran_register_bc.php' method='POST'>";
										echo "<tr>";
