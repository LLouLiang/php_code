  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
			  	...
			  	<form action="veteran_search_industry.php" method="POST" class="form-horizontal">
            ...
            <!-- /industry_work -->
					...
					<tbody id = "myTable">
						<?php
							include("../dbc.php");
							$q = "SELECT * FROM users WHERE role = 'mentor' AND industry_work = '$industry_selected' AND uname not in (SELECT mentor_name FROM requests WHERE veteran_name = '$uname')";
							...
							while ($row = mysqli_fetch_array($r)){
								...
								echo "<tr>";
									...
									echo "<form action='veteran_search_industry.php' method='POST'>";
