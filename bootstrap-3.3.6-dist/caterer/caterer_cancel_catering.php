        ...
        <div class="jumbotron">
					...
					<?php
						...
						echo "<div class='alert alert-warning alert-dismissible' role='alert'>
							...
							$to = $email;
							$subject = 'A Caterer has canceled attending to boot camp';
							$message = "Hi ". $fname .", \n\nThe Caterer $_SESSION[uname] has canceled his/her attending to the boot camp! .\nClick here to login.\nhttp://vetworking.x10host.com/bootstrap-3.3.6-dist/index.php\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
					...
					<div class="table-responsive">
						...
						<?php
							...
							while ($row = mysqli_fetch_array($r)){
								echo "<form action='caterer_cancel_catering.php' method='POST'>";
								echo "<tr>";
