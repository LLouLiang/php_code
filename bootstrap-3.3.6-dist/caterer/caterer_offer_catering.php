    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
					...
					<p>Here is a list of the boot camps that you can offer catering to:</p>
						...
						<table class="table table-bordered table-hover table-striped">
							...
							<?php
								...
								while ($row = mysqli_fetch_array($rr)){
									echo "<form action='caterer_offer_catering.php' method='POST'>";
										echo "<tr>";
