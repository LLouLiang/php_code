  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
			  	...
			  	<form action="mentor_search_state.php" method="POST" class="form-horizontal">
				...
				<div class="table-responsive">
					...
					<tbody id = "myTable">
						<?php
							...
							$q = "SELECT * FROM users WHERE role = 'veteran' AND state = '$state_selected' AND uname not in (SELECT veteran_name FROM requests WHERE mentor_name = '$uname')";
							...
							while ($row = mysqli_fetch_array($r)){
								...
								echo "<tr>";
									...
									echo "<form action='mentor_search_state.php' method='POST'>";
