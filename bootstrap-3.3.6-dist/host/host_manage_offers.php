      ...
      <div class="row">
        ...
        <div class="jumbotron">
					...
					<?php
						...
						$q = "SELECT email,fname FROM users WHERE uname = '$username'";
					...
					<?php
						...
						$update2 = "UPDATE bootcamps_attendances SET att_status='approved' WHERE (att_id = '$att_id')";

						$zz= mysqli_query($dbc, $update2);
						$q1 = "SELECT email,fname FROM users WHERE uname = '$username'";
						...
						echo "<div class='alert alert-success alert-dismissible' role='alert'>
									...
									<strong>Warning!</strong> The offer has been successfully approved!
									</div>";

							$to = $email1;
							$subject = 'You have been approved by a veteran';
							$message = "Hi ". $fname .", \n\nYou have been approved from a Veteran from Vetworking Sysyem .\nClick here to login.\nhttp://vetworking.x10host.com/bootstrap-3.3.6-dist/index.php\n\nThis is a system email. Please do not reply!\n\nThank You!\n\nVetworking System";
							$headers = 'From: Veyworking System' . "\r\n" .
											'Reply-To: ' . "\r\n" .
											'X-Mailer: PHP/' . phpversion();
							mail($to, $subject, $message, $headers);
					...
					<p>Here is a list of offers to be approved or declined:</p>
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover table-striped">
							...
							<tr class="info">
								<th> Offered By </th>
								<th> The user's role </th>
								<th> Boot Camp Title </th>
								<th> Description </th>
								<th> Starts Date </th>
								<th> End Date </th>
								<th> Time </th>
							...
							<?php
								//connect to database
								include("../dbc.php");
								$q = "SELECT * FROM bootcamps_attendances WHERE bc_host_name = '$_SESSION[uname]' AND att_status = 'waiting'";
								$r = mysqli_query($dbc, $q);

								while ($row = mysqli_fetch_array($r)){
									echo "<form action='host_manage_offers.php' method='POST'>";
									echo "<tr>";
										...
										echo '<td id="center-th"><input type = "submit" class="btn btn-success" name = "approve" value = "Approve" />';
										echo '</td>';
										echo '<td id="center-th"><input type = "submit" class="btn btn-danger" name = "decline" value = "Decline" />';
										echo '</td>';
