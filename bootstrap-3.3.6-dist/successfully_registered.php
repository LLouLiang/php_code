  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="jumbotron">
					<div class="alert alert-success" role="alert"><strong>Well done! </strong>You have successfully registered :)</div>
					<h4>You'll be redirected to the login page .. Please wait</h4>
